...
<div class="wrapper">
 ...
 -->          
          <!-- <li class="nav-item has-treeview">
            <a href="#" class="nav-link @yield('addwork')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('addwork')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add First Work Section</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('add_second_work')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Second Work Section</p>
                </a>
              </li>
            </ul>
          </li> -->
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('add_description')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Title & Paragraph</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('add_first_image')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Image</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link @yield('second')">
              <i class="nav-icon fas fa-tree"></i>
              <p>
                Body Second Section
                <i class="fas fa-angle-left right"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('add_sec_description')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Title & Paragraph</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('add_second_image')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Image</p>
                </a>
              </li>
          ...
          <!-- <li class="nav-item">
            <a href="{{url('addwork')}}" class="nav-link @yield('add_work')">
