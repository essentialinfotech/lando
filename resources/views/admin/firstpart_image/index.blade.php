          ...
          <div class="col-md-8">
                  ...
                  <tbody>
                    @forelse($all_image as $index => $image)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('image_active')}}/{{$image->id}}" class="btn @php echo $image->status == 0?'bg-maroon':'bg-blue'@endphp">
                            @php
                        ...
                        <td>
                          <a href="{{url('edit_image')}}/{{$image->id}}" class="btn bg-navy"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          <a href="{{url('image_delete')}}/{{$image->id}}" class="btn bg-orange"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    @empty
                    <tr>
            ...
            <!-- general form elements -->
	            ...
	            <div class="card card-primary">
	              ...
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form action="{{url('first_image_post')}}" method="POST" enctype="multipart/form-data">
	              	@csrf
	                <div class="card-body">
