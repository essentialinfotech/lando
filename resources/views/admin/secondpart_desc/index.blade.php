    	...
    	<div class="row">
          ...
          <div class="col-md-8">
              ...
              <div class="card-header">
                <h3 class="card-title">Second Description Table</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    @forelse($all_desc as $index => $desc)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('sec_desc_active')}}/{{$desc->id}}" class="btn @php echo $desc->status == 0?'bg-maroon':'bg-blue'@endphp">
                            @php
                        ...
                        <td>
                          <a href="{{url('sec_desc_edit')}}/{{$desc->id}}" class="btn bg-navy"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          <a href="{{url('sec_desc_trash')}}/{{$desc->id}}" class="btn bg-orange"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                    @empty
                    <tr>
            ...
            <!-- general form elements -->
	            ...
	            <div class="card card-primary">
	              ...
	              <!-- /.card-header -->
	              <!-- form start -->
	              <form action="{{url('add_sec_description_post')}}" method="POST" enctype="multipart/form-data">
	              	@csrf
	                <div class="card-body">
